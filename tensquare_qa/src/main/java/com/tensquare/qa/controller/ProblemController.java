...
public class ProblemController {
	...
	public Result newlist(@PathVariable String labelid, @PathVariable int page,@PathVariable int rows){
		Page<Problem> newlist = problemService.newlist(labelid, page, rows);
	...
	public Result hotlist(String labelid, int page, int rows){
		Page<Problem> hotlist = problemService.hotlist(labelid, page, rows);
	...
	public Result waitlist(String labelid, int page, int rows){
		Page<Problem> waitlist = problemService.hotlist(labelid, page, rows);
